...
def run_start_generation_job(blog_id: str) -> None:
    init_db()
...
def run_resume_generation_job(blog_id: str, reviewed_plan: dict) -> None:
    init_db()
    started_at = time.monotonic()
...
def run_ai_edit_job(blog_id: str, instruction: str) -> None:
    init_db()
